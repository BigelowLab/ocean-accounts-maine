...
TO keep things simple for the end user, set up a text file (YAML format)
in the users home directory: `~/.oame`

The from within R store the correct data path into the file. Here’s an
example, but obviously you would amend the path to fit your situation.
